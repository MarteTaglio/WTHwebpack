...
import Record from "./lib/RecordArtist.js";

// sintassi es2015 per far caricare una funzione quando si fa IMPORT di questo file
export default function(jsonList) {
  document.getElementById("recordListArt").innerText = "";

  var posizione = 1;

  jsonList.forEach(function(recordSettings) {
    // per ogni record creo un nuovo oggetto record che aggiungo all'array dichiarato prima
